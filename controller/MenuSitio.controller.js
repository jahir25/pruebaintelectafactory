sap.ui.define([
   ...
   "sap/m/MessageToast",
    ...
    "use strict";
    return BaseController.extend("sap.ui.entelantenas.controller.MenuSitio", {
        onInit : function () {
        ...
        onPressNuevoSitio: function(oEvent) {
            this.goTo(oEvent, 1);
        },
        onPressListarSitio: function(oEvent) {
            this.goTo(oEvent, 2);
        }
    });
});