sap.ui.define([
   ...
   "sap/m/MessageBox"
    ...
    var that;
    var click = 0;
    return BaseController.extend("sap.ui.entelantenas.controller.ListarPortadora", {
        onInit : function () {
            var oRouter = this.getOwnerComponent().getRouter();
            oRouter.getRoute("listarPortadora").attachMatched(function(oEvent) {
        ...
        getPortadoras: function(){
        	...
        	$.ajax({
                ...
                success: function(result, status, xhr){
                    ...
                    that.getView().byId('tblPortadora').setModel(oModel);
                    that.getView().byId('tblPortadora').getColumns()[0].setVisible(false);
                },
                error: function(xhr, status, error){
                    MessageBox.error("Error de Conexion");
                },
        ...
        goTo: function(oClick){            
            ...
            var oTable =  this.getView().byId("tblPortadora").getItems();            
        ...
        onFiltros: function(oId){
            ...
            var oColumns = this.getView().byId("tblPortadora").mAggregations.columns;
        ...
        onAction: function(oEvent){            
            ...
            if(oGroup1 == "b"){
                ...
                var oTable = oView.byId("tblPortadora");
            ...
            if(oFilter == null && controlRerender == 2){
                this.getView().byId("tblPortadora").setModel(that.oData());
                click = 1;
                this.goTo(click);
            }
        },
        ...
        onUpdate: function(oEvent){
            ...
            var oRouter = this.getOwnerComponent().getRouter();
            oRouter.navTo("editarPortadora", {
                "id_portadora": window.btoa(codigo)
            });            
        },
