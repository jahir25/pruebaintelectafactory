sap.ui.define([
   ...
   "sap/m/MessageBox"
    ...
    var that;
    var click = 0;
    return BaseController.extend("sap.ui.entelantenas.controller.ListarValores", {
        onInit : function () {
            var oRouter = this.getOwnerComponent().getRouter();
            oRouter.getRoute("listarValores").attachMatched(function(oEvent) {
        ...
        getPortadoras: function(){
        	...
        	$.ajax({
                ...
                success: function(result, status, xhr){
                    ...
                    that.getView().byId('tblValores').setModel(oModel);
                    that.getView().byId('tblValores').getColumns()[0].setVisible(false);
                },
                error: function(xhr, status, error){
                    MessageBox.error("Error de Conexion");
                },
        ...
        goTo: function(oClick){            
            ...
            var oTable =  this.getView().byId("tblValores").getItems();            
        ...
        onFiltros: function(oId){
            ...
            var oColumns = this.getView().byId("tblValores").mAggregations.columns;
        ...
        onAction: function(oEvent){            
            ...
            if(oGroup1 == "b"){
                ...
                var oTable = oView.byId("tblValores");
            ...
            if(oFilter == null && controlRerender == 2){
                this.getView().byId("tblValores").setModel(that.oData());
                click = 1;
                this.goTo(click);
            }
        },
        ...
        onUpdate: function(oEvent){
            ...
            var oRouter = this.getOwnerComponent().getRouter();
            oRouter.navTo("editarValores", {
                "id_valor": window.btoa(codigo)
            });            
        },
