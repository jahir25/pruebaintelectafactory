sap.ui.define([
   ...
   "sap/m/MessageBox"
    ...
    var that;
    var click = 0;
    return BaseController.extend("sap.ui.entelantenas.controller.ListarSitio", {
        onInit : function () {
            that = this;
            var oRouter = this.getOwnerComponent().getRouter();
            oRouter.getRoute("listarSitio").attachMatched(function(oEvent) {
        ...
        getSitios: function(){
        	...
        	$.ajax({
                ...
                success: function(result, status, xhr){
                    ...
                    that.getView().byId('tblSitio').setModel(oModel);
                },
                error: function(xhr, status, error){
                    MessageBox.error("Error de Conexion");
                },
        ...
        goTo: function(oClick){            
            ...
            var oTable =  this.getView().byId("tblSitio").getItems();            
        ...
        onFiltros: function(oId){
            ...
            var oColumns = this.getView().byId("tblSitio").mAggregations.columns;
        ...
        onAction: function(oEvent){            
            ...
            if(oGroup1 == "b"){
                ...
                var oTable = oView.byId("tblSitio");
            ...
            if(oFilter == null && controlRerender == 2){
                this.getView().byId("tblSitio").setModel(that.oData());
                click = 1;
                this.goTo(click);
            }
        },
        ...
        onUpdate: function(oEvent){
            ...
            oRouter.navTo("editarSitio", {
                "codigo": window.btoa(codigo)
            });            
        },
        onDelete: function(oEvent){
            var codigo = oEvent.getSource().oParent.mAggregations.cells[0].mProperties.text;            
            var state = oEvent.getSource().oParent.mAggregations.cells[4].mProperties.state;
            ...
            sap.m.MessageBox.confirm("Desea "+ action +" el sitio: "+ codigo, {
